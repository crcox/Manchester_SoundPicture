...
BLURFWHM = ENV.fetch('BLURFWHM').to_i {4}
DATADIR = ENV.fetch('DATADIR') {"#{HOME}/MRI/Manchester/data/raw"}
...
TXT_NODESTRENGTH_TLRC = Rake::FileList["txt/nodestrength/??.mni"]
TXT_STABILITY_TLRC = Rake::FileList["txt/stability/??.mni"]
TXT_MASK_TLRC = Rake::FileList["txt/mask/??.mni"]
...
RANK_NODESTRENGTH_TLRC = AFNI_NODESTRENGTH_TLRC.pathmap("rank/nodestrength/%f")
RANK_NODESTRENGTH_TLRC_BLUR = TXT_NODESTRENGTH_TLRC.pathmap("rank/nodestrength/%n.b#{BLURFWHM}+tlrc.HEAD")
RANK_STABILITY_TLRC = AFNI_STABILITY_TLRC.pathmap("rank/stability/%f")
RANK_STABILITY_TLRC_BLUR = TXT_STABILITY_ORIG_O.pathmap("rank/stability/%n.b#{BLURFWHM}+tlrc.HEAD")
...
NONPARAMETRIC_NODESTRENGTH_TLRC = "nonparametric_nodestrength+tlrc.HEAD"
NONPARAMETRIC_NODESTRENGTH_TLRC_BLUR = "nonparametric_nodestrength.b#{BLURFWHM}+tlrc.HEAD"
NONPARAMETRIC_STABILITY_TLRC = "nonparametric_stability+tlrc.HEAD"
NONPARAMETRIC_STABILITY_TLRC_BLUR = "nonparametric_stability.b#{BLURFWHM}+tlrc.HEAD"
...
MEAN_NODESTRENGTH_TLRC = "mean_nodestrength+tlrc.HEAD"
MEAN_NODESTRENGTH_TLRC_BLUR = "mean_nodestrength.b#{BLURFWHM}+tlrc.HEAD"
MEAN_STABILITY_TLRC = "mean_stability+tlrc.HEAD"
MEAN_STABILITY_TLRC_BLUR = "mean_stability.b#{BLURFWHM}+tlrc.HEAD"
...
OVERLAP_TLRC = "overlap+tlrc.HEAD"
...
MEAN_RANK_NODESTRENGTH_TLRC = "mean_rank_nodestrength+tlrc.HEAD"
MEAN_RANK_NODESTRENGTH_TLRC_BLUR = "mean_rank_nodestrength.b#{BLURFWHM}+tlrc.HEAD"
MEAN_RANK_STABILITY_TLRC = "mean_rank_stability+tlrc.HEAD"
MEAN_RANK_STABILITY_TLRC_BLUR = "mean_rank_stability.b#{BLURFWHM}+tlrc.HEAD"
...
PERMUTATIONS_NODESTRENGTH_TLRC = Rake::FileList["#{PERMDIR}/afni/nodestrength/???_??+tlrc.HEAD"]
PERMUTATIONS_STABILITY_TLRC = Rake::FileList["#{PERMDIR}/afni/stability/???_??+tlrc.HEAD"]
...
PERMUTATIONS_NODESTRENGTH_TLRC_BY_SUBJ = SUBJECT_INDEX.collect {|s| PERMUTATIONS_NODESTRENGTH_TLRC.grep(/[0-9]+_#{s}/)}
PERMUTATIONS_STABILITY_TLRC_BY_SUBJ = SUBJECT_INDEX.collect {|s| PERMUTATIONS_STABILITY_TLRC.grep(/[0-9]+_#{s}/)}
...
PERMUTATIONS_NODESTRENGTH_TLRC_BY_PERM = PERMUTATION_INDEX.collect {|p| PERMUTATIONS_NODESTRENGTH_TLRC.grep(/#{p}_[0-9]+/)}
PERMUTATIONS_STABILITY_TLRC_BY_PERM = PERMUTATION_INDEX.collect {|p| PERMUTATIONS_STABILITY_TLRC.grep(/#{p}_[0-9]+/)}
...
PNG_NONPARAMETRICI_NODESTRENGTH_TLRC_C_BLUR = [
  ...
  NONPARAMETRICI_NODESTRENGTH_TLRC_C_BLUR.sub('+tlrc.HEAD','_q05.png'),
  NONPARAMETRICI_NODESTRENGTH_TLRC_C_BLUR.sub('+tlrc.HEAD','_q01.png'),
  NONPARAMETRICI_NODESTRENGTH_TLRC_C_BLUR.sub('+tlrc.HEAD','_q001.png')]
...
PNG_NONPARAMETRICI_STABILITY_TLRC_C_BLUR = [
  ...
  NONPARAMETRICI_STABILITY_TLRC_C_BLUR.sub('+tlrc.HEAD','_q05.png'),
  NONPARAMETRICI_STABILITY_TLRC_C_BLUR.sub('+tlrc.HEAD','_q01.png'),
  NONPARAMETRICI_STABILITY_TLRC_C_BLUR.sub('+tlrc.HEAD','_q001.png')]
...
PNG_NONPARAMETRIC_NODESTRENGTH_TLRC_C = [
  ...
  NONPARAMETRIC_NODESTRENGTH_TLRC_C.sub('+tlrc.HEAD','_q05.png'),
  NONPARAMETRIC_NODESTRENGTH_TLRC_C.sub('+tlrc.HEAD','_q01.png'),
  NONPARAMETRIC_NODESTRENGTH_TLRC_C.sub('+tlrc.HEAD','_q001.png')]
...
PNG_NONPARAMETRIC_STABILITY_TLRC_C = [
  ...
  NONPARAMETRIC_STABILITY_TLRC_C.sub('+tlrc.HEAD','_q05.png'),
  NONPARAMETRIC_STABILITY_TLRC_C.sub('+tlrc.HEAD','_q01.png'),
  NONPARAMETRIC_STABILITY_TLRC_C.sub('+tlrc.HEAD','_q001.png')]
...
PNG_NONPARAMETRIC_NODESTRENGTH_TLRC_C_BLUR = [
  ...
  NONPARAMETRIC_NODESTRENGTH_TLRC_C_BLUR.sub('+tlrc.HEAD','_q05.png'),
  NONPARAMETRIC_NODESTRENGTH_TLRC_C_BLUR.sub('+tlrc.HEAD','_q01.png'),
  NONPARAMETRIC_NODESTRENGTH_TLRC_C_BLUR.sub('+tlrc.HEAD','_q001.png')]
...
PNG_NONPARAMETRIC_STABILITY_TLRC_C_BLUR = [
  ...
  NONPARAMETRIC_STABILITY_TLRC_C_BLUR.sub('+tlrc.HEAD','_q05.png'),
  NONPARAMETRIC_STABILITY_TLRC_C_BLUR.sub('+tlrc.HEAD','_q01.png'),
  NONPARAMETRIC_STABILITY_TLRC_C_BLUR.sub('+tlrc.HEAD','_q001.png')]

PNG_NONPARAMETRIC_NODESTRENGTH_TLRC_BLUR = [
  NONPARAMETRIC_NODESTRENGTH_TLRC_BLUR.sub('+tlrc.HEAD','_p05.png'),
  NONPARAMETRIC_NODESTRENGTH_TLRC_BLUR.sub('+tlrc.HEAD','_p01.png'),
  NONPARAMETRIC_NODESTRENGTH_TLRC_BLUR.sub('+tlrc.HEAD','_p001.png'),
  NONPARAMETRIC_NODESTRENGTH_TLRC_BLUR.sub('+tlrc.HEAD','_q05.png'),
  NONPARAMETRIC_NODESTRENGTH_TLRC_BLUR.sub('+tlrc.HEAD','_q01.png'),
  NONPARAMETRIC_NODESTRENGTH_TLRC_BLUR.sub('+tlrc.HEAD','_q001.png')]
PNG_NONPARAMETRIC_STABILITY_TLRC_BLUR = [
  NONPARAMETRIC_STABILITY_TLRC_BLUR.sub('+tlrc.HEAD','_p05.png'),
  NONPARAMETRIC_STABILITY_TLRC_BLUR.sub('+tlrc.HEAD','_p01.png'),
  NONPARAMETRIC_STABILITY_TLRC_BLUR.sub('+tlrc.HEAD','_p001.png'),
  NONPARAMETRIC_STABILITY_TLRC_BLUR.sub('+tlrc.HEAD','_q05.png'),
  NONPARAMETRIC_STABILITY_TLRC_BLUR.sub('+tlrc.HEAD','_q01.png'),
  NONPARAMETRIC_STABILITY_TLRC_BLUR.sub('+tlrc.HEAD','_q001.png')]
...
nonparametric_all_for_plotting = [
  ...
  NONPARAMETRIC_NODESTRENGTH_TLRC_BLUR,
  ...
  NONPARAMETRIC_STABILITY_TLRC_BLUR,
...
txt_orig_o = [
  TXT_NODESTRENGTH_TLRC,
  TXT_STABILITY_TLRC
]
afni_orig_o_raw.zip(txt_orig_o).each do |afni_list,txt_list|
  afni_list.zip(txt_list,MASK_ORIG_O).each do |target,source|
...
rank_lol = [
  RANK_NODESTRENGTH_TLRC_BLUR,
  RANK_STABILITY_TLRC_BLUR
]
a_lol = [
  AFNI_NODESTRENGTH_TLRC,
  AFNI_STABILITY_TLRC
...
rank_lol.zip(a_lol, p_lolol).each do |target_list,source_list,perm_lol| # loop over metric
  target_list.zip(source_list,perm_lol).each do |target,source,perm_list| # loop over subject
    file target => source do
      nonparametric_rank_against_permutation_distribution(target, source, perm_list, SHARED_ATLAS, BLURFWHM)
    end
    CLOBBER.push(target)
    CLOBBER.push(target.sub(".HEAD",".BRIK"))
    CLOBBER.push(target.sub(".HEAD",".BRIK.gz"))
...
nonparametric_all = [
  ...
  NONPARAMETRICI_STABILITY_TLRC_C,
  NONPARAMETRICI_STABILITY_TLRC_C_BLUR,
  NONPARAMETRIC_NODESTRENGTH_TLRC,
  NONPARAMETRIC_NODESTRENGTH_TLRC_BLUR,
  NONPARAMETRIC_NODESTRENGTH_TLRC_C,
  NONPARAMETRIC_NODESTRENGTH_TLRC_C_BLUR,
  NONPARAMETRIC_L2NORM_TLRC_C,
