function [Results,Avg,Params] = load_results_searchlight(RESULT_DIR,SOLUTION_DIR,DATA_DIR,COND_FILE,META_FILE,TRIAL_MODALITY,WRITE,FLAG_WRITECV,CountRadius)
  % Load metadata
